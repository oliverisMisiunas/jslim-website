export const howDocs = {
    ...
    text: [
        "Due to changes in the file structure of JSlim library this page is currently being edited.",
        "Sorry for the inconvenience. This tutorial will be available on 2022/03/25.",
        "For now, you can find the information on how to use JSlim library <a href='https://github.com/oliverisMisiunas/jslim-library'>here</a>"
        // "To use JSlim you need to have Node.js installed on your computer.",
        ...
        // "When you link your JavaScript file in your HTML, make sure to include <span id='teal-color'>type=’module’</span> in the script tag just like that <span id='teal-color'>&lt;script type='module' src='app.js'&gt;&lt;/script&gt;</span>",
